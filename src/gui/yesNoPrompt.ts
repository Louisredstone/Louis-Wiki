// This file is copied from [QuickAdd](https://github.com/chhoumann/quickadd)and modified.
// Thanks for the contribution of chhoumann!
...
export async function yesNoPrompt(app: App, header: string, text?: string): Promise<boolean|undefined> {
    try {
